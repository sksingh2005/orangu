...
- Local commands such as `/help`, `/models`, `/list_files`, `/show_file`, `/tools`, `/diff`, `/status`, `/log`, `/pull`, `/rebase`, `/merge`, `/checkout`, `/add_file`, `/remove_file`, `/move_file`, `/cherry_pick`, `/commit`, `/amend`, `/push`, `/init_repo`, `/squash`, `/delete`, and `/open_file`
