...
| `word_wrap` | No | Wrap text lines to the available terminal width instead of using the virtual width canvas. Applies only to LLM output. Defaults to `off`. Options: `on`, `true`, `1`, `off`, `false`, `0` |
